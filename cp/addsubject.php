...
<table align = center width = 98% cellpadding = 0 cellspacing =0 border = 0 bgcolor=#FFFFFF>
				...
				<tr>
					...
					<tr>
						...
						<td height="32">
						<input type = text name = title size="41"></td>
					</tr>
					<tr>
						<td height="109" valign = top><b>Abbreviation:</b></td>
						<td height="109" valign =top>
						<textarea name = abriv style="width: 100%; height:192"></textarea></td>
					</tr>
					<tr>
						<td valign = top><b>Context : </b> </td>
						<td><textarea name = context id="elm1" style="width: 100%; height:400"></textarea></td>
					</tr>
					<tr>
						<td colspan = 2 align =center><input type =submit name = addnew value = Add accesskey=A>&nbsp;&nbsp; <input type = reset value = Clear></td>
					</tr>
					</form>
					</table>		
					</td>
